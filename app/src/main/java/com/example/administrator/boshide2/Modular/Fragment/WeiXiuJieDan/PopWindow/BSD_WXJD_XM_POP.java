package com.example.administrator.boshide2.Modular.Fragment.WeiXiuJieDan.PopWindow;
...
public class BSD_WXJD_XM_POP extends PopupWindow implements AbPullToRefreshView.OnHeaderRefreshListener, AbPullToRefreshView.OnFooterLoadListener, View.OnClickListener {
    //行布局选中效果
...
URLS url;
    public BSD_WXJD_XM_POP(final Activity context) {
        url=new URLS();
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_WXJD_XM_POP.this != null)
                    BSD_WXJD_XM_POP.this.dismiss();
                gb.guanbi();
            }
        });
...
//            context.getWindow().setAttributes(lp);
    ...
    public void gb(BSD_WXJD_XM_POP.Guanbi dismiss) {
        this.gb = dismiss;
