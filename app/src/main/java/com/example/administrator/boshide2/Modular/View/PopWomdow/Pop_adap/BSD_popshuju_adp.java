...
public class BSD_popshuju_adp extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;
    List<HashMap<String, String>> list;


    public BSD_popshuju_adp(Context context, List<HashMap<String, String>> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view=layoutInflater.inflate(R.layout.bsd_pop_shuju_item,null);
