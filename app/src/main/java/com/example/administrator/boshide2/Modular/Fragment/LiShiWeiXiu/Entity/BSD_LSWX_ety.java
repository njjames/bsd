package com.example.administrator.boshide2.Modular.Fragment.LiShiWeiXiu.Entity;
...
public class BSD_LSWX_ety {
    ...
    private String kehu_dh;//电话
    private String che_cx;
    private String kehu_no;
    private String kehu_sj;
    private String che_no;
    private String xche_sfbz;
    private String xche_sffl;
    private String xche_lc;
    private String xche_cy;
    private String xche_jdrq;
    private String xche_gj;
    private String xche_wxjd;
    private String xche_wgrq;
    private String xche_pgcz;
    private String xche_jlr;
    private String xche_jlrq;
    private String xche_jsr;
    private String xche_jsrq;
    private String xche_fpfs;
    private String xche_fplv;
    private String xche_rgf;
    private String xche_rgsl;
    private String xche_rgse;
    private String xche_rgbh;
    private String xche_clf;
    private String xche_clsl;
    private String xche_clse;
    private String xche_clbh;
    private String xche_glf;
    private String xche_wjgf;
    private String xche_wjgcb;
    private String xche_qtf;
    private String xche_yhje;
    private String xche_ysje;
    private String xche_rgcb;
    private String xche_cb;
    private String xche_zxr;
    private String xche_qtxm;
    private String xche_wjgx;
    private String xche_yhyy;
    private String xche_gdfl;//业务类型
    private String xche_wxfl;
    private String xche_bz;
    private String xche_cz;
    private String xche_jb;
    private String xche_hjje;
    private String xche_ssje;
    private String xche_yeje;
    private String xche_jsfs;
    private String dept_mc;
    private String xche_fpno;
    private String xche_kpje;
    private String xche_kpse;
    private boolean flag_fast;
    private String card_no;
    private String card_kind;
    private boolean flag_cardjs;
    private String zhifu_card_no;
    private String zhifu_card_je;
    private String xche_gj_wx;
    private String xche_gj_ll;
    private String zhifu_card_xj;
    private String card_itemrate;
    private String card_peijrate;
    private int xche_state;
    private String xche_dinge;
    ...
    private String yuyue_String;
    private String xche_sjhk;
    private String temp_hk;
    private String xche_yqhk;
    private boolean flag_hk;
    private String xche_wxxmlv;
    private String xche_peijlv;
    ...
    public String getXche_sffl() {
        return xche_sffl;
    }

    public void setXche_sffl(String xche_sffl) {
        this.xche_sffl = xche_sffl;
    }

    public String getXche_lc() {
        return xche_lc;
    }

    public void setXche_lc(String xche_lc) {
        this.xche_lc = xche_lc;
    }
    ...
    public String getXche_jdrq() {
        return xche_jdrq;
    }

    public void setXche_jdrq(String xche_jdrq) {
        this.xche_jdrq = xche_jdrq;
    }

    public String getXche_gj() {
        return xche_gj;
    }

    public void setXche_gj(String xche_gj) {
        this.xche_gj = xche_gj;
    }
    ...
    public String getXche_wgrq() {
        return xche_wgrq;
    }

    public void setXche_wgrq(String xche_wgrq) {
        this.xche_wgrq = xche_wgrq;
    }
    ...
    public String getXche_jlrq() {
        return xche_jlrq;
    }

    public void setXche_jlrq(String xche_jlrq) {
        this.xche_jlrq = xche_jlrq;
    }
    ...
    public String getXche_jsrq() {
        return xche_jsrq;
    }

    public void setXche_jsrq(String xche_jsrq) {
        this.xche_jsrq = xche_jsrq;
    }
    ...
    public String getXche_fplv() {
        return xche_fplv;
    }

    public void setXche_fplv(String xche_fplv) {
        this.xche_fplv = xche_fplv;
    }

    public String getXche_rgf() {
        return xche_rgf;
    }

    public void setXche_rgf(String xche_rgf) {
        this.xche_rgf = xche_rgf;
    }

    public String getXche_rgsl() {
        return xche_rgsl;
    }

    public void setXche_rgsl(String xche_rgsl) {
        this.xche_rgsl = xche_rgsl;
    }

    public String getXche_rgse() {
        return xche_rgse;
    }

    public void setXche_rgse(String xche_rgse) {
        this.xche_rgse = xche_rgse;
    }

    public String getXche_rgbh() {
        return xche_rgbh;
    }

    public void setXche_rgbh(String xche_rgbh) {
        this.xche_rgbh = xche_rgbh;
    }

    public String getXche_clf() {
        return xche_clf;
    }

    public void setXche_clf(String xche_clf) {
        this.xche_clf = xche_clf;
    }

    public String getXche_clsl() {
        return xche_clsl;
    }

    public void setXche_clsl(String xche_clsl) {
        this.xche_clsl = xche_clsl;
    }

    public String getXche_clse() {
        return xche_clse;
    }

    public void setXche_clse(String xche_clse) {
        this.xche_clse = xche_clse;
    }

    public String getXche_clbh() {
        return xche_clbh;
    }

    public void setXche_clbh(String xche_clbh) {
        this.xche_clbh = xche_clbh;
    }

    public String getXche_glf() {
        return xche_glf;
    }

    public void setXche_glf(String xche_glf) {
        this.xche_glf = xche_glf;
    }

    public String getXche_wjgf() {
        return xche_wjgf;
    }

    public void setXche_wjgf(String xche_wjgf) {
        this.xche_wjgf = xche_wjgf;
    }

    public String getXche_wjgcb() {
        return xche_wjgcb;
    }

    public void setXche_wjgcb(String xche_wjgcb) {
        this.xche_wjgcb = xche_wjgcb;
    }

    public String getXche_qtf() {
        return xche_qtf;
    }

    public void setXche_qtf(String xche_qtf) {
        this.xche_qtf = xche_qtf;
    }

    public String getXche_yhje() {
        return xche_yhje;
    }

    public void setXche_yhje(String xche_yhje) {
        this.xche_yhje = xche_yhje;
    }

    public String getXche_ysje() {
        return xche_ysje;
    }

    public void setXche_ysje(String xche_ysje) {
        this.xche_ysje = xche_ysje;
    }

    public String getXche_rgcb() {
        return xche_rgcb;
    }

    public void setXche_rgcb(String xche_rgcb) {
        this.xche_rgcb = xche_rgcb;
    }

    public String getXche_cb() {
        return xche_cb;
    }

    public void setXche_cb(String xche_cb) {
        this.xche_cb = xche_cb;
    }
    ...
    public String getXche_hjje() {
        return xche_hjje;
    }

    public void setXche_hjje(String xche_hjje) {
        this.xche_hjje = xche_hjje;
    }

    public String getXche_ssje() {
        return xche_ssje;
    }

    public void setXche_ssje(String xche_ssje) {
        this.xche_ssje = xche_ssje;
    }

    public String getXche_yeje() {
        return xche_yeje;
    }

    public void setXche_yeje(String xche_yeje) {
        this.xche_yeje = xche_yeje;
    }
    ...
    public String getXche_kpje() {
        return xche_kpje;
    }

    public void setXche_kpje(String xche_kpje) {
        this.xche_kpje = xche_kpje;
    }

    public String getXche_kpse() {
        return xche_kpse;
    }

    public void setXche_kpse(String xche_kpse) {
        this.xche_kpse = xche_kpse;
    }

    public boolean isFlag_fast() {
        return flag_fast;
    }
    ...
    public String getZhifu_card_je() {
        return zhifu_card_je;
    }

    public void setZhifu_card_je(String zhifu_card_je) {
        this.zhifu_card_je = zhifu_card_je;
    }

    public String getXche_gj_wx() {
        return xche_gj_wx;
    }

    public void setXche_gj_wx(String xche_gj_wx) {
        this.xche_gj_wx = xche_gj_wx;
    }

    public String getXche_gj_ll() {
        return xche_gj_ll;
    }

    public void setXche_gj_ll(String xche_gj_ll) {
        this.xche_gj_ll = xche_gj_ll;
    }

    public String getZhifu_card_xj() {
        return zhifu_card_xj;
    }

    public void setZhifu_card_xj(String zhifu_card_xj) {
        this.zhifu_card_xj = zhifu_card_xj;
    }

    public String getCard_itemrate() {
        return card_itemrate;
    }

    public void setCard_itemrate(String card_itemrate) {
        this.card_itemrate = card_itemrate;
    }

    public String getCard_peijrate() {
        return card_peijrate;
    }

    public void setCard_peijrate(String card_peijrate) {
        this.card_peijrate = card_peijrate;
    }
    ...
    public String getXche_dinge() {
        return xche_dinge;
    }

    public void setXche_dinge(String xche_dinge) {
        this.xche_dinge = xche_dinge;
    }
    ...
    public String getXche_sgsj() {
        return xche_sgsj;
    }

    public void setXche_sgsj(String xche_sgsj) {
        this.xche_sgsj = xche_sgsj;
    }
    ...
    public String getYuyue_String() {
        return yuyue_String;
    }

    public void setYuyue_String(String yuyue_String) {
        this.yuyue_String = yuyue_String;
    }

    public String getXche_sjhk() {
        return xche_sjhk;
    }

    public void setXche_sjhk(String xche_sjhk) {
        this.xche_sjhk = xche_sjhk;
    }

    public String getTemp_hk() {
        return temp_hk;
    }

    public void setTemp_hk(String temp_hk) {
        this.temp_hk = temp_hk;
    }

    public String getXche_yqhk() {
        return xche_yqhk;
    }

    public void setXche_yqhk(String xche_yqhk) {
        this.xche_yqhk = xche_yqhk;
    }

    public boolean isFlag_hk() {
        return flag_hk;
    }
    ...
    public String getXche_wxxmlv() {
        return xche_wxxmlv;
    }

    public void setXche_wxxmlv(String xche_wxxmlv) {
        this.xche_wxxmlv = xche_wxxmlv;
    }

    public String getXche_peijlv() {
        return xche_peijlv;
    }

    public void setXche_peijlv(String xche_peijlv) {
        this.xche_peijlv = xche_peijlv;
    }

    public String getXche_wxxmglf() {
        return xche_wxxmglf;
    }

    public void setXche_wxxmglf(String xche_wxxmglf) {
        this.xche_wxxmglf = xche_wxxmglf;
    }

    public String getXche_peijglf() {
        return xche_peijglf;
    }

    public void setXche_peijglf(String xche_peijglf) {
        this.xche_peijglf = xche_peijglf;
    }

    public String getYuyue_eString() {
        return yuyue_eString;
    }

    public void setYuyue_eString(String yuyue_eString) {
        this.yuyue_eString = yuyue_eString;
    }
    ...
    public String getXche_last_lc() {
        return xche_last_lc;
    }

    public void setXche_last_lc(String xche_last_lc) {
        this.xche_last_lc = xche_last_lc;
    }

    public String getXche_last_jdrq() {
        return xche_last_jdrq;
    }

    public void setXche_last_jdrq(String xche_last_jdrq) {
        this.xche_last_jdrq = xche_last_jdrq;
    }
    ...
    public String getXche_sbclf() {
        return xche_sbclf;
    }

    public void setXche_sbclf(String xche_sbclf) {
        this.xche_sbclf = xche_sbclf;
    }

    public String getXche_sbgss() {
        return xche_sbgss;
    }

    public void setXche_sbgss(String xche_sbgss) {
        this.xche_sbgss = xche_sbgss;
    }

    public String getXche_sbgsf() {
        return xche_sbgsf;
    }

    public void setXche_sbgsf(String xche_sbgsf) {
        this.xche_sbgsf = xche_sbgsf;
    }

    public String getXche_sbclcb() {
        return xche_sbclcb;
    }

    public void setXche_sbclcb(String xche_sbclcb) {
        this.xche_sbclcb = xche_sbclcb;
    }

    public String getXche_sbgsff() {
        return xche_sbgsff;
    }

    public void setXche_sbgsff(String xche_sbgsff) {
        this.xche_sbgsff = xche_sbgsff;
    }

    public String getXche_bxclf() {
        return xche_bxclf;
    }

    public void setXche_bxclf(String xche_bxclf) {
        this.xche_bxclf = xche_bxclf;
    }

    public String getXche_bxgss() {
        return xche_bxgss;
    }

    public void setXche_bxgss(String xche_bxgss) {
        this.xche_bxgss = xche_bxgss;
    }

    public String getXche_bxgsf() {
        return xche_bxgsf;
    }

    public void setXche_bxgsf(String xche_bxgsf) {
        this.xche_bxgsf = xche_bxgsf;
    }

    public String getXche_bxclcb() {
        return xche_bxclcb;
    }

    public void setXche_bxclcb(String xche_bxclcb) {
        this.xche_bxclcb = xche_bxclcb;
    }

    public String getXche_bxgscb() {
        return xche_bxgscb;
    }

    public void setXche_bxgscb(String xche_bxgscb) {
        this.xche_bxgscb = xche_bxgscb;
    }

    public String getXche_xzrgf_je() {
        return xche_xzrgf_je;
    }

    public void setXche_xzrgf_je(String xche_xzrgf_je) {
        this.xche_xzrgf_je = xche_xzrgf_je;
    }

    public String getXche_xzclf_je() {
        return xche_xzclf_je;
    }

    public void setXche_xzclf_je(String xche_xzclf_je) {
        this.xche_xzclf_je = xche_xzclf_je;
    }
    ...
    public String getXche_jianyi_lc() {
        return xche_jianyi_lc;
    }

    public void setXche_jianyi_lc(String xche_jianyi_lc) {
        this.xche_jianyi_lc = xche_jianyi_lc;
    }
    ...
    public String getXche_zjkgrq() {
        return xche_zjkgrq;
    }

    public void setXche_zjkgrq(String xche_zjkgrq) {
        this.xche_zjkgrq = xche_zjkgrq;
    }

    public String getXche_zjwgrq() {
        return xche_zjwgrq;
    }

    public void setXche_zjwgrq(String xche_zjwgrq) {
        this.xche_zjwgrq = xche_zjwgrq;
    }

    public String getXche_xckgrq() {
        return xche_xckgrq;
    }

    public void setXche_xckgrq(String xche_xckgrq) {
        this.xche_xckgrq = xche_xckgrq;
    }

    public String getXche_xcwgrq() {
        return xche_xcwgrq;
    }

    public void setXche_xcwgrq(String xche_xcwgrq) {
        this.xche_xcwgrq = xche_xcwgrq;
    }

    public String getXche_kgrq() {
        return xche_kgrq;
    }

    public void setXche_kgrq(String xche_kgrq) {
        this.xche_kgrq = xche_kgrq;
    }

    public boolean isFlag_isxiche() {
        return flag_isxiche;
    }
    ...
    public String getGujia_imptrq() {
        return gujia_imptrq;
    }

    public void setGujia_imptrq(String gujia_imptrq) {
        this.gujia_imptrq = gujia_imptrq;
    }

    public boolean isFlag_NotRemind() {
    ...
    public String getXche_haocai_je() {
        return xche_haocai_je;
    }

    public void setXche_haocai_je(String xche_haocai_je) {
        this.xche_haocai_je = xche_haocai_je;
    }

    public String getXche_haocai_cb() {
        return xche_haocai_cb;
    }

    public void setXche_haocai_cb(String xche_haocai_cb) {
        this.xche_haocai_cb = xche_haocai_cb;
    }
    ...
    public String getXche_cclc() {
        return xche_cclc;
    }

    public void setXche_cclc(String xche_cclc) {
        this.xche_cclc = xche_cclc;
    }

    public String getWxxm_tcje_sum() {
        return wxxm_tcje_sum;
    }

    public void setWxxm_tcje_sum(String wxxm_tcje_sum) {
        this.wxxm_tcje_sum = wxxm_tcje_sum;
    }

    public String getPeij_tcje_sum() {
        return peij_tcje_sum;
    }

    public void setPeij_tcje_sum(String peij_tcje_sum) {
        this.peij_tcje_sum = peij_tcje_sum;
    }

    public String getWxxm_zztcje_sum() {
        return wxxm_zztcje_sum;
    }

    public void setWxxm_zztcje_sum(String wxxm_zztcje_sum) {
        this.wxxm_zztcje_sum = wxxm_zztcje_sum;
    }

    public String getXche_saobmianshou() {
        return xche_saobmianshou;
    }

    public void setXche_saobmianshou(String xche_saobmianshou) {
        this.xche_saobmianshou = xche_saobmianshou;
    }

    public String getXche_bxmianshou() {
        return xche_bxmianshou;
    }

    public void setXche_bxmianshou(String xche_bxmianshou) {
        this.xche_bxmianshou = xche_bxmianshou;
    }

    public String getXche_zengsgsf() {
        return xche_zengsgsf;
    }

    public void setXche_zengsgsf(String xche_zengsgsf) {
        this.xche_zengsgsf = xche_zengsgsf;
    }

    public String getXche_zengsclf() {
        return xche_zengsclf;
    }

    public void setXche_zengsclf(String xche_zengsclf) {
        this.xche_zengsclf = xche_zengsclf;
    }

    public String getXche_zengsmianshou() {
        return xche_zengsmianshou;
    }

    public void setXche_zengsmianshou(String xche_zengsmianshou) {
        this.xche_zengsmianshou = xche_zengsmianshou;
    }

    public String getXche_wxxm_yhje() {
        return xche_wxxm_yhje;
    }

    public void setXche_wxxm_yhje(String xche_wxxm_yhje) {
        this.xche_wxxm_yhje = xche_wxxm_yhje;
    }

    public String getXche_peij_yhje() {
        return xche_peij_yhje;
    }

    public void setXche_peij_yhje(String xche_peij_yhje) {
        this.xche_peij_yhje = xche_peij_yhje;
    }

    public String getWork_jifen_sum() {
        return work_jifen_sum;
    }

    public void setWork_jifen_sum(String work_jifen_sum) {
        this.work_jifen_sum = work_jifen_sum;
    }

    public boolean isFlag_pad() {
        return flag_pad;
    }
