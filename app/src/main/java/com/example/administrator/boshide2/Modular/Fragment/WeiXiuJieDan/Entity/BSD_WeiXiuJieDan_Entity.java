package com.example.administrator.boshide2.Modular.Fragment.WeiXiuJieDan.Entity;
...
public class BSD_WeiXiuJieDan_Entity {
    ...
    private String xche_bz;  //故障描述 备注
    ...
    public String getYuyue_edate() {
        return yuyue_edate;
    }

    public void setYuyue_edate(String yuyue_edate) {
    ...
    public String getChe_biaoshi() {
        return che_biaoshi;
    }

    public void setChe_biaoshi(String che_biaoshi) {
