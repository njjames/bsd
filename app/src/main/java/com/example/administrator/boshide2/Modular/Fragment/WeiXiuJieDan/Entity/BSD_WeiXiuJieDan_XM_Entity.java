...
public class BSD_WeiXiuJieDan_XM_Entity {
    private int reco_no;
    ...
    private String wxxm_pgrq;

    private double wxxm_zk;

    private String wxxm_tgrq;

    private String wxxm_fxrq;
    ...
    private String xche_sjwgrq;

    private String xche_ztrq;

    private String xche_jxrq;

    private int xche_ztsj;

    private String xche_zdrq;

    private String xche_zdkgrq;
    ...
    public String getWxxm_pgrq() {
        return wxxm_pgrq;
    }

    public void setWxxm_pgrq(String wxxm_pgrq) {
    ...
    public String getWxxm_tgrq() {
        return wxxm_tgrq;
    }

    public void setWxxm_tgrq(String wxxm_tgrq) {
        this.wxxm_tgrq = wxxm_tgrq;
    }

    public String getWxxm_fxrq() {
        return wxxm_fxrq;
    }

    public void setWxxm_fxrq(String wxxm_fxrq) {
    ...
    public String getXche_sjwgrq() {
        return xche_sjwgrq;
    }

    public void setXche_sjwgrq(String xche_sjwgrq) {
        this.xche_sjwgrq = xche_sjwgrq;
    }

    public String getXche_ztrq() {
        return xche_ztrq;
    }

    public void setXche_ztrq(String xche_ztrq) {
        this.xche_ztrq = xche_ztrq;
    }

    public String getXche_jxrq() {
        return xche_jxrq;
    }

    public void setXche_jxrq(String xche_jxrq) {
    ...
    public String getXche_zdrq() {
        return xche_zdrq;
    }

    public void setXche_zdrq(String xche_zdrq) {
        this.xche_zdrq = xche_zdrq;
    }

    public String getXche_zdkgrq() {
        return xche_zdkgrq;
    }

    public void setXche_zdkgrq(String xche_zdkgrq) {
    ...
    public String getWxxm_bjrq() {
        return wxxm_bjrq;
    }

    public void setWxxm_bjrq(String wxxm_bjrq) {
