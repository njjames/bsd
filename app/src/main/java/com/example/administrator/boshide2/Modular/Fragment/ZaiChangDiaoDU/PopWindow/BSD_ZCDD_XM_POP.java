...
import com.example.administrator.boshide2.Modular.Fragment.ZaiChangDiaoDU.PopWindow.PopAdapter.BSD_ZCDD_XM_PopYou_adp;
import com.example.administrator.boshide2.Modular.Fragment.ZaiChangDiaoDU.PopWindow.PopAdapter.BSD_ZCDD_XM_Popzuo_adp;
...
public class BSD_ZCDD_XM_POP extends PopupWindow {
    //行布局选中效果
    ...
    BSD_ZCDD_XM_Popzuo_adp adapter;
    List<String> list = new ArrayList<>();
    RelativeLayout bsd_di, bsd_tou;
    List<HashMap<String, String>> data = new ArrayList<>();
    BSD_ZCDD_XM_PopYou_adp adapter1;
    //关闭监听事件
    private Guanbi gb;

    public BSD_ZCDD_XM_POP(final Activity context) {
    ...
    public void init(int w, int heitht) {
        ...
        contentView = inflater.inflate(R.layout.bsd_zcdd_xm_popwin, null);
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_ZCDD_XM_POP.this != null)
                    BSD_ZCDD_XM_POP.this.dismiss();
                gb.guanbi();
            }
        });
...
//项目选择
     ...
     */
    public void xiangmu() {
        adapter = new BSD_ZCDD_XM_Popzuo_adp(context, list);
    ...
    public void liebiao() {
        ...
        adapter1 = new BSD_ZCDD_XM_PopYou_adp(context, data);
