...
public class BSD_WXJD_CL_POP extends PopupWindow implements AbPullToRefreshView.OnHeaderRefreshListener, AbPullToRefreshView.OnFooterLoadListener {
    //行布局选中效果
...
URLS url;
    public BSD_WXJD_CL_POP(final Activity context) {
        url=new URLS();
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_WXJD_CL_POP.this != null)
                    BSD_WXJD_CL_POP.this.dismiss();
                gb.guanbi();
            }
        });
