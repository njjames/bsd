...
import com.example.administrator.boshide2.Modular.Fragment.KuaiSuBaoJiao.PopWinow.PopAdapter.BSD_KSBJ_XM_PopZuo_adp;
...
public class BSD_XZCL_POP extends PopupWindow {
    ...
    BSD_KSBJ_XM_PopZuo_adp adapter1;

    private Guanbi gb;

    public BSD_XZCL_POP(final Activity context) {
    ...
    public void init(int w, int heitht) {
        ...
        contentView = inflater.inflate(R.layout.bsd_xzcl_popwin, null);
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_XZCL_POP.this != null)
                    BSD_XZCL_POP.this.dismiss();
                gb.guanbi();
            }
        });
...
//        adapter = new BSD_KSBJ_XM_PopYou_adp(context, list);
...
//    }
    ...
    public void liebiao() {
        ...
        adapter1 = new BSD_KSBJ_XM_PopZuo_adp(context, data);
