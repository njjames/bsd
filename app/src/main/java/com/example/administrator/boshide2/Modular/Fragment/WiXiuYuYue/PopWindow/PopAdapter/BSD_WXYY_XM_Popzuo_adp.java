 ...
 * 博士德popwind个全部项目选项
 */
public class BSD_WXYY_XM_Popzuo_adp extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;
    private List<String> list = new ArrayList<>();

    public BSD_WXYY_XM_Popzuo_adp(Context context, List<String> list) {
    ...
    public View getView(int pos, View contetview, ViewGroup viewGroup) {
        ...
        if (contetview == null) {
            ...
            contetview = layoutInflater.inflate(R.layout.bsd_wxyy_xm_popzuo_item, null);
