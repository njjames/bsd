...
public class BSD_KSBJ_XM_POP extends PopupWindow implements AbPullToRefreshView.OnHeaderRefreshListener, AbPullToRefreshView.OnFooterLoadListener, View.OnClickListener {
    //行布局选中效果
    ...
    BSD_KSBJ_XM_PopYou_adp adapter1;


    private BSD_KSBJ_XM_POP.Guanbi gb;
    ...
    public void setClist(BSD_WXYY_XM_POP.chuanlist clist) {
        this.clist = clist;
    }

    private BSD_WXYY_XM_POP.chuanlist clist;
    String neirong;
    ...
    URLS url;
    public BSD_KSBJ_XM_POP(final Activity context) {
        url=new URLS();
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_KSBJ_XM_POP.this != null)
                    BSD_KSBJ_XM_POP.this.dismiss();
                gb.guanbi();
            }
        });
...
//        bsd_wexyy_tjxiangmu.setOnClickListener(this);
        ...
        adapter1 = new BSD_KSBJ_XM_PopYou_adp(context);
        adapter1.setOnAddListener(new BSD_KSBJ_XM_PopYou_adp.OnAddListener() {
            @Override
...
//项目选择
    ...
    public void xmdj(final BSD_wxyy_xm_pop_entiy wxxm_no) {
...
//        params.put("che_no", Conts.cp);
        params.put("wxxm_no",wxxm_no.getWxxm_no());
        params.put("che_cx", Conts.chexing);
        params.put("che_no", Conts.cp);
        params.put("fenlei", 1);
        params.put("no", Conts.list_no);
        params.put("feil_mc", Conts.feilv_name);   //费率名称
        Log.i("wxdj000", "项目单价的费率 ---"+Conts.feilv_name);
        Log.i("cjn","wxxm_no=="+wxxm_no.getWxxm_no()
                +"-------che_cx=="+Conts.chexing+"---------che_no=="+Conts.cp+"----------" +
                "-----fenlei=="+1+"----------no=="+ Conts.list_no);
        ...
        Request.Post(MyApplication.shared.getString("ip", "")+url.BSD_xm_dj, params, new AbStringHttpResponseListener() {
            ...
            public void onSuccess(int i, String s) {
                ...
                clist.onYesClick(wxxm_no, wxxmdj);
                Log.i("cjn", "维修项目单价" + s.toString());
...
//            context.getWindow().setAttributes(lp);
    ...
    public void gb(BSD_KSBJ_XM_POP.Guanbi dismiss) {
        this.gb = dismiss;
...
//    }
    ...
    public void reightdata() {
        list_pop_xm.clear();
        Log.i("cjn","page="+page+"====lbdm===="+lbdm+"====lx====="+lx+"=====neirong"+neirong);
        AbRequestParams params = new AbRequestParams();
            ...
            public void onSuccess(int a, String s) {
                try {
                    ...
                    if (json.get("message").toString().equals("查询成功")) {
                        ...
                        adapter1.setmLists(list_pop_xm);
                        adapter1.notifyDataSetChanged();
