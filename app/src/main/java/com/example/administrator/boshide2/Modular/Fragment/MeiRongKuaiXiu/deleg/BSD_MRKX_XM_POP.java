...
public class BSD_MRKX_XM_POP extends PopupWindow implements AbPullToRefreshView.OnHeaderRefreshListener, AbPullToRefreshView.OnFooterLoadListener, View.OnClickListener {
    //行布局选中效果
    ...
    public BSD_MRKX_XM_POP(final Activity context) {
        url = new URLS();
...
// 设置SelectPicPopupWindow弹出窗体动画效果
        ...
        bsd_tou.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (BSD_MRKX_XM_POP.this != null)
                    BSD_MRKX_XM_POP.this.dismiss();
                gb.guanbi();
            }
        });
...
//项目选择
    ...
    public void xmdj(final BSD_wxyy_xm_pop_entiy entiy, String wxxm_no) {
            ...
            mAdapter.setOnTreeNodeClickListener(new TreeListViewAdapter.OnTreeNodeClickListener() {
                ...
                public void onClick(Node node, int position) {
                    if (node.isLeaf()) {
                        ...
                        list_pop_xm.clear();
                        reightdata();
                        Toast.makeText(context, node.getId(),
...
//            context.getWindow().setAttributes(lp);
    ...
    public void gb(BSD_MRKX_XM_POP.Guanbi dismiss) {
        this.gb = dismiss;
