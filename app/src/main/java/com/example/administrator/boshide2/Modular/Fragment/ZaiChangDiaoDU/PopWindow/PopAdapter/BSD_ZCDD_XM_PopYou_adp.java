package com.example.administrator.boshide2.Modular.Fragment.ZaiChangDiaoDU.PopWindow.PopAdapter;
...
public class BSD_ZCDD_XM_PopYou_adp extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;
    List<HashMap<String, String>> list;


    public BSD_ZCDD_XM_PopYou_adp(Context context, List<HashMap<String, String>> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view=layoutInflater.inflate(R.layout.bsd_zcdd_xm_popyou_item,null);
...
//        holder.bsd_kxbj_cz.setText(list.get(i).get("caozuo"));
