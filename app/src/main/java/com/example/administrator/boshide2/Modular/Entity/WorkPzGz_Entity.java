...
public class WorkPzGz_Entity {
    ...
    public double getXche_yysje() {
        return xche_yysje;
    }

    public void setXche_yysje(double xche_yysje) {
        this.xche_yysje = xche_yysje;
    }

    public double getXche_yzkje() {
        return xche_yzkje;
    }

    public void setXche_yzkje(double xche_yzkje) {
        this.xche_yzkje = xche_yzkje;
    }

    public double getXche_yrgf() {
        return xche_yrgf;
    }

    public void setXche_yrgf(double xche_yrgf) {
        this.xche_yrgf = xche_yrgf;
    }

    public double getXche_yclf() {
        return xche_yclf;
    }

    public void setXche_yclf(double xche_yclf) {
        this.xche_yclf = xche_yclf;
    }
