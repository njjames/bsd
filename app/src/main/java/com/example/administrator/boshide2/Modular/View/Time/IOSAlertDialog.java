 ...
 public class IOSAlertDialog {
	...
	public IOSAlertDialog builder() {
		...
		txt_timename=(TextView)view.findViewById(R.id.txt_timename);
		...
		// 调整dialog背景大小
		lLayout_bg.setLayoutParams(new FrameLayout.LayoutParams((int) (display.getWidth() * 0.5), LayoutParams.WRAP_CONTENT));

		return this;
	}
	public void daxiao(double a)
	{
		lLayout_bg.setLayoutParams(new FrameLayout.LayoutParams((int) (display.getWidth() * a), LayoutParams.WRAP_CONTENT));
	...
	public void xianshiname(String name){
		txt_timename.setVisibility(View.VISIBLE);
		txt_timename.setText(name);
