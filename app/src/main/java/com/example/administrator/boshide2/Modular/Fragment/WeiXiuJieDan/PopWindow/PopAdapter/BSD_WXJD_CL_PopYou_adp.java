...
public class BSD_WXJD_CL_PopYou_adp extends BaseAdapter {
    private Context mContext;
    private LayoutInflater layoutInflater;
    List<HashMap<String, String>> list;


    public BSD_WXJD_CL_PopYou_adp(Context context, List<HashMap<String, String>> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view=layoutInflater.inflate(R.layout.bsd_wxjd_cl_popyou_item,null);
