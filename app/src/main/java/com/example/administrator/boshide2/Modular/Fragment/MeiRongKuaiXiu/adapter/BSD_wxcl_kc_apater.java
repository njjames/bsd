...
public class BSD_wxcl_kc_apater extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.dialog_stockinfo_item, null);
    ...
    public final class Holder {
        TextView bsd_tv_kc_ckmc;
        TextView bsd_tv_kc_dqkc;
        TextView bsd_tv_kc_pjdj;
        TextView bsd_tv_kc_je;
        TextView bsd_tv_kc_kcsx;
        TextView bsd_tv_kc_kcxx;
        TextView bsd_tv_kc_kw;
    }
